...
class TaskDetailsHeader extends StatefulWidget {
  const TaskDetailsHeader(this.task, {super.key});
  final ProjectTask task;

  @override
  State<TaskDetailsHeader> createState() => _TaskDetailsHeaderState();
}
    ...
    return GetBuilder<ProjectDetailsController>(builder: (controller) {
      return Container(
        ...
        decoration: BoxDecoration(
            color: AppConstants.projectStatusColors[widget.task.status]!
                .withOpacity(0.3),
              ...
              Row(
                ...
                children: [
                  Container(
                    ...
                    decoration: BoxDecoration(
                        color: AppConstants
                            .projectStatusColors[widget.task.status],
                        borderRadius: BorderRadius.circular(AppSize.s16)),
                    child: AutoSizeText(
                      widget.task.status,
