...
import 'package:devoida/app/modules/task-details/views/widgets/task-users/edit_task_select_user_dialog.dart';
...
class EditTaskSelectUserWidget extends GetView<TaskDetailsController> {
  const EditTaskSelectUserWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return InkWell(
      onTap: () {
        Get.dialog(const EditTaskSelectUserDialog());
      },
      child: Container(
