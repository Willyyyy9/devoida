...
import 'package:devoida/app/modules/home/views/widgets/teams/project_team_item.dart';
import 'package:devoida/app/modules/home/views/widgets/teams/project_teams_dialog.dart';
...
class ProjectTeamsWidget extends GetView<HomeController> {
  const ProjectTeamsWidget({super.key});

  @override
  Widget build(BuildContext context) {
    return Obx(() => InkWell(
          onTap: () {
            Get.dialog(const ProjectTeamsDialog());
          },
          child: Container(
